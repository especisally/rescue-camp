...
async function main() {
  ...
  const learningItems = [
    {
      title: '消防战术指挥决策案例分析', type: 'video', category: '战术指挥', author: '消防指挥学院',
      duration: 2700, views: 1250, status: 1,
    },
    {
      title: '国际应急救援体系建设概览', type: 'video', category: '国际视野', author: '应急救援研究中心',
      duration: 1800, views: 680, status: 1,
    },
    {
      title: '消防装备技术创新报告', type: 'doc', category: '装备技术', author: '装备研究所',
      fileSize: '2.4MB', views: 430, status: 1,
    },
    {
      title: '基层消防站体能训练科学化方案', type: 'doc', category: '基础训练', author: '体能训练组',
      fileSize: '1.8MB', views: 890, status: 1,
    },
    {
      title: '大型商业综合体消防安全管理规范', type: 'doc', category: '规范标准', author: '安全管理部',
      fileSize: '3.1MB', views: 560, status: 1,
    },
    {
      title: '无人机在消防救援中的应用实践', type: 'video', category: '新技术', author: '科技信息化处',
      duration: 1500, views: 310, status: 1,
    },
  ];
  ...
  if (!testUser) {
    ...
    console.log('✅ 测试用户: 消防员小王 (id=' + testUser.id + ')');
  }
